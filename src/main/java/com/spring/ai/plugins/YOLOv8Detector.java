 ...
 */
public abstract class YOLOv8Detector {
     ...
     */
    public YOLOv8Detector(String modelPath, int targetWidth, int targetHeight, float confThreshold) {
        this.modelPath = modelPath;
